...
contract ClaimRewards is Ownable {
    ...
    /// @notice Event emitted when rewards is successfully claimed
    event RewardsClaimed(address indexed user, uint256 points, uint256 coins);
    ...
    /**
     * @dev Allows a user to claim rewards by providing a valid signature.
    ...
    function claimRewards(
        ...
        emit RewardsClaimed(msg.sender, points, coins);
    }
